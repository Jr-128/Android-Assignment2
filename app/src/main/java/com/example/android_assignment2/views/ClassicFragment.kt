...
/**
 * Here you have to implemet the view contract no the presenter
 *
 * Presenter will be injected by dagger
 */
class ClassicFragment : Fragment(), IClassicMusicView {
    ...
    @Inject lateinit var classicPresenter: IClassicMusicPresenter

    /**
     * When working with dagger DI
     * you need to let him know where you need the dependencies injected
     *
     * that usually happens in onAttach method for fragments
